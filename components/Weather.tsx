...
import { Input, Button, Card, List, Typography, Col, Row, Switch } from "antd";
      ...
      <div className="app-container" data-theme="dark">
        ...
        <div className="app-content">
          <button className="button button-block">
            <span className="subtle">Period</span> <span>Last 30 days</span>{" "}
          ...
          <button className="button button-link">Update Settings</button>
        </div>
      </div>
    </div>
  );
